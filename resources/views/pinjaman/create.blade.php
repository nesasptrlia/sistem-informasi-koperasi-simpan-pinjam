...
<div class="container mt-2">
    <div class="row mb-4">
        <div class="col">
            <h2 class="fw-bold text-dark">➕ Tambah Pinjaman</h2>
            <p class="text-muted">Isi form berikut untuk menambahkan data pinjaman</p>
        </div>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('pinjaman.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="tanggal_pinjaman" id="tanggal_pinjaman" value="{{ old('tanggal_pinjaman', date('Y-m-d')) }}" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" name="jumlah_pinjaman" id="jumlah_pinjaman" value="{{ old('jumlah_pinjaman') }}" required>
                </div>
                <div class="mb-3">
                    <label for="lama_angsuran" class="form-label fw-semibold">Lama Angsuran (Bulan) <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="lama_angsuran" id="lama_angsuran" value="{{ old('lama_angsuran') }}" min="1" required>
                </div>
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-danger fw-semibold">💾 Simpan</button>
