...
<div class="container mt-2">
    <div class="row mb-4">
        <div class="col">
            <h2 class="fw-bold text-dark">➕ Tambah Angsuran</h2>
            <p class="text-muted">Isi form berikut untuk menambahkan data angsuran</p>
        </div>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('angsuran.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="tanggal_bayar" id="tanggal_bayar" value="{{ old('tanggal_bayar', date('Y-m-d')) }}" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" name="jumlah_bayar" id="jumlah_bayar" value="{{ old('jumlah_bayar') }}" required>
                </div>
